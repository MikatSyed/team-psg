                ...
                <div class="card mt-2 " style={{ width: "18rem" }}>
                    ...
                    <div class="card-body ">
                        ...
                        <h6 class="card-text text-secondary"><FontAwesomeIcon icon={faBirthdayCake} />{birth}</h6>
                                ...
                                <button class="btn btn-primary" onClick={() => props.handleAddPlayer(props.player)} >Add</button>
                                
                                <button class="btn btn-danger ml-2" onClick={() => props.handleDeletePlayer(id)}>Remove</button>
